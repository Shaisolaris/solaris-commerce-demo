...
export const metadata: Metadata = {
  title: "Next.js Buttons | Solaris Commerce - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Solaris Commerce - Next.js Tailwind CSS Admin Dashboard Template",
};
