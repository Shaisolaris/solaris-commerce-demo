...
export const metadata: Metadata = {
  title: "Next.js Badge | Solaris Commerce - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for Solaris Commerce - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
