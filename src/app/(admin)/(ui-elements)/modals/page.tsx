...
export const metadata: Metadata = {
  title: "Next.js Modals | Solaris Commerce - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Solaris Commerce - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
