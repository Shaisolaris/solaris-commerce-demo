...
export const metadata: Metadata = {
  title: "Next.js Avatars | Solaris Commerce - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Solaris Commerce - Next.js Tailwind CSS Admin Dashboard Template",
};
